...
function ShowRealTime() {
    const [currentTime, set_currentTime] = useState(Get_currentTime());
    const [currentDate, set_currentDate] = useState(Get_currentDate_2());
    const [currentLongDay, set_currentLongDay] = useState(Get_currentLongDay());
